import styles from './WesSubNationalHome.module.css';

export default function WesSubNationalHome() {
  return (
    <div className={styles.page}>
      <div className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <h1 className={styles.title}>
            Sub-National Wastewater<br />Surveillance Assessment
          </h1>
      ...
      <div className={styles.statsRow}>
        {[
          { value: '2',  label: 'Member States' },
          { value: '6',  label: 'Assessment Categories' },
