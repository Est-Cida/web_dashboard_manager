import styles from './WesHome.module.css';

export default function WesHome() {
  return (
    <div className={styles.page}>
      {/* Hero with lab background */}
      <div className={styles.hero}>
        <div className={styles.heroOverlay} />
        <div className={styles.heroContent}>
          <div className={styles.badge}>2025v1</div>
          <h1 className={styles.title}>
            Laboratory Wastewater<br />Surveillance Assessment
          </h1>
      ...
      <div className={styles.statsRow}>
        {[
          ...
          { value: '27', label: 'Surveillance Sites' },
